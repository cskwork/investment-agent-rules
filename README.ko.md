...
> 훌륭한 투자는 “이해 가능한 우량 자산을 내재가치보다 싸게, 안전마진을 두고, 감정과 비용을 통제하며, 장기 보유하는 것”이다. 다만 스스로 우위가 없다고 판단되면, 저비용·분산·장기 보유가 최선의 기본값이다.
...
1. **가격이 아니라 가치를 산다.** 출발점은 “이 자산이 무엇을 벌 수 있는가”다. 가격은 할인폭을 정할 뿐, 논거가 아니다. — *Graham, Marks*
2. **안전마진 없이 사지 않는다.** 내가 틀려도 살아남을 만큼 내재가치보다 충분히 낮게 사라. 입력값이 노이즈가 클수록 마진은 더 크게. — *Graham, Buffett*
3. **주식은 사업의 일부다.** 이 implied valuation에서 회사 전체를 살 의향이 있는가? 아니면 주식 한 주도 사지 마라. — *Buffett (Owner's Manual)*
4. **능력의 범위 안에서만 투자한다.** 매출, 고객, 경쟁, 무너뜨릴 요인을 한 문단으로 설명할 수 있는 것만 보유. “모른다”는 유효한 행동. — *Buffett, Lynch*
5. **평범한 기업을 헐값에 사기보다, 훌륭한 기업을 합리적 가격에.** 지속 가능한 해자, 사이클 전반의 높은 ROIC, 가격결정력, 긴 재투자 활주로. 싸다는 건 바닥이고, 품질이 곱셈이다. — *Fisher, Buffett, Munger*
6. **경영진과 자본배분을 검증한다.** 현금의 운명은 경영진이 결정한다. 내부자 지분, 자사주 매입 가격, 인수합병 성과, 희석, 부채 사용, 주주 커뮤니케이션을 본다. — *Buffett*
7. **장기 복리를 방해하지 마라.** 매도 사유 세 가지만 허용: 가설이 틀렸을 때, 사업 품질이 훼손됐을 때, 훨씬 더 좋은 기회가 생겼을 때. 시간은 시그널이 아니다. — *Munger, Buffett*
8. **리스크는 변동성이 아니라 영구손실 가능성이다.** 변동성은 수수료, 영구손상은 복리의 끝. 30~50% 드로다운을 견딜 수 있는 사이즈로. — *Marks*
...
1. 이 사업이 돈을 버는 방식을 한 문단으로 설명할 수 있는가?
2. 현재 가격이 내재가치 추정치보다 의미 있게 낮은가?
3. 내 추정이 20~30% 틀려도 보호되는가?
4. 5년 이상 보유할 수 있는가?
5. 경쟁자가 쉽게 모방하기 어려운 지속 가능한 우위가 있는가?
6. 경영진은 장기 주주처럼 생각하고 자본을 쓰는가?
7. 부채, 희석, 규제, 기술 변화, 단일 고객 의존성이 영구손실을 만들 수 있는가?
...
- Benjamin Graham, *The Intelligent Investor* — 안전마진, 투자자와 투기자의 구분, Mr. Market.
- Warren Buffett, 버크셔 *Owner's Manual*과 연례 주주서한 — 주식은 사업의 일부, 내재가치, 경영진의 자본배분.
...
- Howard Marks, *The Most Important Thing*과 Oaktree 메모 — 2차원적 사고, 사이클, 영구손실로서의 리스크.
